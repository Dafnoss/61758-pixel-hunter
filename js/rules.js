...
const moduleTwoElementHtml = `<header class="header">
...
const moduleTwoElement = util.getElementFromTemplate(moduleTwoElementHtml);

moduleTwoElement.querySelector(`.rules__button`).addEventListener(`click`, () => {
    drawBlock(gameOne);
});

getBackToFirstScreen(moduleTwoElement);
